...
const Footer=()=>{
    return(
        <footer className="w-full py-14 bg-slate-950">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                />
                    ...
                    <h1 className="w-40 h-8 text-2xl ml-3 font-bold" >Otkau Web</h1>
                </div>
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li><Link href="/" className="text-white hover:text-gray-400">Top Anime</Link></li>
                        <li><Link href="/login" className=" text-white hover:text-gray-400">Our Services</Link></li>
                        <li><Link href="/animesongs" className=" text-white hover:text-gray-400">Anime Songs</Link></li>
                        <li><Link href="#" className=" text-white hover:text-gray-400">Blogs</Link></li>
                        <li><Link href="#" className=" text-white hover:text-gray-400">Help & Support</Link></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="#" className="block  text-blue-500 transition-all duration-500 hover:text-white">
                        ...
                        <a href="#" className="block  text-pink-600 transition-all duration-500 hover:text-white ">
                        ...
                        <a href="#" className="block  text-blue-800 transition-all duration-500 hover:text-indigo-600 ">
                        ...
                        <a href="#" className="block  text-red-600 transition-all duration-500 hover:text-white ">
